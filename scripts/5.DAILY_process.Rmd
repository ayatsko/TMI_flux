...
d1 <- ggplot(CH4_day, aes(x = time_of_day, y = flux.CH4, fill = time_of_day))+
  geom_boxplot()+
  theme_classic()+
...
# with replicates
d2 <- ggplot(CH4_day, aes(x = time_of_day, y = flux.CH4, fill = sample))+
  geom_boxplot()+
  theme_classic()+
  facet_wrap(~species, scales = "free")
ggarrange(d1, d2, ncol = 1)

d3 <- ggplot(CO2_day, aes(x = time_of_day, y = flux.CO2, fill = time_of_day))+
  geom_boxplot()+
  theme_classic()+
  theme(legend.position="none")+
  facet_wrap(~species, scales = "free")
...
# with replicates
d4 <- ggplot(CO2_day, aes(x = time_of_day, y = flux.CO2, fill = sample))+
  geom_boxplot()+
  theme_classic()+
  facet_wrap(~species, scales = "free")
...
ggplot(CO2_day, aes(x = time_of_day, y = avg_respT, fill = time_of_day))+
  geom_boxplot()+
  theme_classic()+
  theme(legend.position="none")+
  facet_wrap(~species, scales = "free")
