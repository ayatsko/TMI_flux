...
identify standardisation value lower limit total reads (pathways)
```{r}
...
ggplot(flux_relabund_pos, aes(x = resampled_relabund_scaled, y = log(flux.CH4), color = species_s)) + 
  geom_point() + 
