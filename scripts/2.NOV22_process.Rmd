...
ggplot(fixed1, aes(x = fDOY, y = CO2_dry))+
  geom_point()+
  theme_classic()
...
CO2_fluxfinal_nov22_fixed$ID_measurement <- paste(CO2_fluxfinal_nov22_fixed$sample, CO2_fluxfinal_nov22_fixed$tag, sep = "-")
CH4_fluxfinal_nov22_fixed$ID_measurement <- paste(CH4_fluxfinal_nov22_fixed$sample, CH4_fluxfinal_nov22_fixed$tag, sep = "-")
...
table(CO2_fluxfinal_nov22_fixed$p.CO2<0.05) # all CO2 is fine (either removed or fluxes are fixed)
table(CH4_fluxfinal_nov22_fixed$p.CH4<0.05)
a <- CH4_fluxfinal_nov22_fixed[CH4_fluxfinal_nov22_fixed$p.CH4>0.05,]
...
zero_flux <- function(CH4_fluxfinal_nov22_fixed, CH4_to_zero, assign_zeros_CH4) {
  # Replace columns in assign_zeros_CH4 with 0 for ID_measurement values in CH4_to_zero
  CH4_fluxfinal_nov22_fixed <- CH4_fluxfinal_nov22_fixed %>%
    mutate_at(vars(all_of(assign_zeros_CH4)), ~ ifelse(ID_measurement %in% CH4_to_zero, 0, .))
  
  return(CH4_fluxfinal_nov22_fixed)
}

CH4_fluxfinal_nov22_fixed_zeroadj <- zero_flux(CH4_fluxfinal_nov22_fixed, CH4_to_zero, assign_zeros_CH4)
```
...
# CH4 (units are umol/day)
# write.csv(CH4_fluxfinal_nov22_fixed_zeroadj,"/Users/abbeyyatsko/Desktop/repos/TMI_flux/data/finalfluxes/CH4_fluxfinal_nov22_fixed.csv", row.names = FALSE)
```