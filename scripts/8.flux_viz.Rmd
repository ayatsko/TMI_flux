...
# What are the fluxes associated with termites in the mound vs. termites isolated from mound
...
ggplot(all_fluxes_mound_avg, aes(x = SA_m2, y = mean_mound_fluxCH4, color = species_s)) + # swap out basal_area_m2, color = campaign
  geom_point()+ 
