...
# calculate estimated termite biomass 
p_fluxes_f$t_biomass_g_cm3 <- p_fluxes_f$mass_termite_g / p_fluxes_f$material_volume_cm3
...
# Define min and max for each axis to form the cube boundaries
